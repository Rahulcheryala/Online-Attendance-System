...
<body>
    <?php
     ...
     if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $myusername = mysqli_real_escape_string($db,$_POST['Phone number']);
        $mypassword = mysqli_real_escape_string($db,$_POST['Password']);

        $sql = "SELECT * FROM medical history WHERE Phone_number = '$myusername' and password = '$mypassword'";
  ...
  ?>
    ...
    <div id="bdy">
        ...
        <form action="existinguser.php" method="post">
            <label for="username" style="color:white; font-size:25px">Phone number : </label>
            ...
            <button id="id1" type="submit">Login</button>
